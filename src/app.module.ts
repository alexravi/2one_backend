...
import { PalmPhoto } from './palms/entities/palm-photo.entity';
import { PalmsModule } from './palms/palms.module';
  ...
  imports: [
    ...
    TypeOrmModule.forRootAsync({
      ...
      useFactory: (configService: ConfigService) => ({
        ...
        entities: [User, Recording, Wallet, Transaction, PayoutRequest, PalmSubmission, PalmPhoto],
        synchronize: true,
